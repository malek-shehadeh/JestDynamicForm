...
export interface FormField {
  type: 'text' | 'password' | 'checkbox' | 'select'; // Add all supported types
  name: string;
  label: string;
  placeholder?: string;
  required?: boolean;
  ...
  validation: FormFieldValidation;
  helperText?: string; // Add helperText
  clearable?: boolean; // Add clearable
  size?: 'small' | 'medium' | 'large'; // Add size
  fullWidth?: boolean; // Add fullWidth
  defaultValue?: string; // Add defaultValue
  optional?: boolean; // Add optional
}
